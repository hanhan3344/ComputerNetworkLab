...
void get_print_msg(int *r_size, int s_fd)
{
...
void send_mail(const char* receiver, const char* subject, const char* msg, const char* att_path)
{
    ...
    const char* pass = "TkRKSVpHVUhHRVpRSU1QWg=="; // TODO: Specify the password
    const char* from = "hanhan3344_2023@163.com"; // TODO: Specify the mail address of the sender
    ...
    const char* from_encoded = "aGFuaGFuMzM0NF8yMDIzQDE2My5jb20=";
